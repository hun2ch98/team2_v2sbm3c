...
//	@Override
//	public String pagingBox(int memberno, int now_page, String ethical, int search_count,
...
//	
//	str.append("<span class='span_box_1'><A href='" + ethical + "?memberno=" + memberno + "&now_page=" + _now_page
//	+ "'>이전</A></span>");
//	  }
//	  
//	  // 중앙의 페이지 목록
...
//	  str.append("<span class='span_box_1'><A href='" + ethical + "?memberno=" + memberno + "&now_page=" + i + "'>" + i
//	  + "</A></span>");
//	    }
//	  }
//	  
