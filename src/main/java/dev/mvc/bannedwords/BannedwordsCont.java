...
//  }
  ...
  public String update_text(HttpSession session,
    ...
    if (this.memberProc.isMember(session)) {
        ...
        // /templates/bannedwords/update_text.html
  ...
  public String update_text(
    ...
    // word 값 검증
    if (bannedwordsVO.getWord() == null || bannedwordsVO.getWord().trim().isEmpty()) {
      ra.addFlashAttribute("message", "금지 단어는 필수 입력 사항입니다.");
